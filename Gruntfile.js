// Generated on 2014-02-02 using generator-socketio 0.0.2
'use strict';
var moment = require('moment');

var LIVERELOAD_PORT = 35729;
var RUNNING_PORT = 3333; // <- if you change this, you need to change in public/js/app.js and recompile
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      dist: {
        src: ['public/js/app.js', 'public/js/comment.js'],
